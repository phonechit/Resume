...
const translations = {
    en: {
        ...
        exp_title_audit: "Xokthavy Trading Import-Export Sole Co., Ltd.", exp_org_audit: "Warehouse Management / Audit & KPI",
    ...
    th: {
        ...
        about_p1: "ผมชื่อ พอนจิด อินทะสอน (Phonechit INTHASONE) เกิดเมื่อวันที่ 27 พฤศจิกายน 2004 ที่บ้านย้อ, เมืองแบง, แขวงอุดมไซ เป็นคนที่ใส่ใจในรายละเอียด สามารถทำงานเป็นทีมได้ มีพื้นฐานด้านการตรวจสอบคลังสินค้า, การติดตามตัวชี้วัด KPI, กลยุทธ์การขาย และการออกแบบสร้างสรรค์",
